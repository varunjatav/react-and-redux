...
const Sidebar = ({selectedTab, setSelectedTab}) => {
 return  <div className="d-flex flex-column flex-shrink-0 p-3 text-bg-dark sidebar" style={{"width": "10%"}}>
 ...
 <ul className="nav nav-pills flex-column mb-auto">
   ...
   <li>
     <a href="#" className={`nav-link  ${selectedTab === "Create Post" && "active"}`} onClick={()=> setSelectedTab("Create Post")}>
       Create Post
     </a>
   </li>
